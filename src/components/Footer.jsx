      ...
      <ul className="flex gap-4">
        {socialLinks.map((link, index) => (
          <li key={index}>
            <a
              href={`/link/${index}`}
              aria-label={`Visit our ${link[1]} page`}
              target="_blank"
              rel="noopener noreferrer"
            >
              <img src={link[0]} alt={`${link[1]} logo`} />
            </a>
          </li>
        ))}
      </ul>
...
export const Footer = () => {
  return (
    <footer className="bg-dark-blue">
      <div className="flex flex-col items-center space-y-8 px-4 py-10 lg:flex-row lg:justify-between lg:space-y-0">
        <div className="flex flex-col items-center space-y-8 lg:flex-row lg:gap-20 lg:space-y-0">
          ...
          <nav aria-label="Company Information">
            <ul className="flex flex-col items-center space-y-2 lg:flex-row lg:gap-20">
        ...
        <div className="flex flex-col items-center space-y-8 lg:space-y-4">
          <InviteButton styles="flex" />
          <div className="text-gray-blue-dark">
